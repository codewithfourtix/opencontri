...
export default function Home() {
  ...
  return (
    ...
    >
      {/* GitHub Star Button */}
      <a
        href="https://github.com/yourusername/github-contribution-analyzer"
        target="_blank"
        rel="noopener noreferrer"
        className="absolute top-8 left-1/2 -translate-x-1/2 flex items-center gap-2 px-4 py-2.5 rounded-lg bg-[#1a1a1a] hover:bg-[#242424] border border-[#33333366] hover:border-[#444444] text-[#999999] text-xs font-mono transition-all duration-300"
      >
      ...
      <div
        ...
        style={{
          backgroundImage: 'linear-gradient(#33333306 1px, transparent 1px), linear-gradient(90deg, #33333306 1px, transparent 1px)',
      ...
      <div className="w-full max-w-2xl relative z-10">
        ...
        <div className="mb-10 text-center">
          <pre className="text-[#33333366] text-[8px] md:text-[10px] leading-tight select-none mb-6 overflow-hidden">
{`  ██████╗ ██╗████████╗██╗  ██╗██╗   ██╗██████╗ 
 ██╔════╝ ██║╚══██╔══╝██║  ██║██║   ██║██╔══██╗
 ██║  ███╗██║   ██║   ███████║██║   ██║██████╔╝
 ██║   ██║██║   ██║   ██╔══██║██║   ██║██╔══██╗
